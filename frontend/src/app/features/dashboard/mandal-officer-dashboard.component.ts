...
@Component({
    selector: 'app-mandal-officer-dashboard',
    standalone: true,
    imports: [CommonModule],
    templateUrl: './mandal-officer-dashboard.component.html'
})
export class MandalOfficerDashboardComponent implements OnInit {
